...
4. EventController에서 저장된 viewname이 일치하는 파일을 xml에서 쫙 훑어 찾아서 연결해줌 와 신기...

-> dispatcher-servlet.xml 의 tilesConfigurer에서 template-*.xml 파일과 연결
```
...
5. WebContent/WEB-INF/jsp/promotion/preRegistInvite/ge/index.jsp 에서 화면구현
