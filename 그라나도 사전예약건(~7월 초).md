...
요약 : 해당 메서드에서 로그인정보(미로그인시 입력값없음)와 setting 된 redis 세팅 값을 view에 저장해 index로 전달

3. WebContent/WEB-INF/jsp/promotion/preRegistInvite/ge/index.jsp 에서 화면구현
	/WEB-INF/jsp/promotion/preRegistInvite/(게임명)/index.jsp

-> 이게 어떻게연결....? 어디서확인?
src/com/jc/view/template-promotion.xml 에 연결될 index 페이지 입력 _ tiles 사용해서 조각조각땃땃따
-> 아니그래서 이 수많은 tiles 조각들 중 그라나다 index인걸 어디서 확인...?
-> EventController에서 저장된 viewname이 일치하는 파일을 xml에서 쫙 훑어 찾아서 연결해줌 와 신기...
